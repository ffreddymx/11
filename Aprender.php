...
<div id="carouselExampleCaptions" class="carousel slide" data-interval="false" style="margin-top: 0px">
...
<?php    foreach ($view->tabla1 as $value) { ?>
    ...
    <div class="carousel-item <?php if(($value['id']-1)==0) echo "active"; ?> ">
      ...
      <div class="carousel-caption d-none d-md-block">
        ...
        <a class="btn btn-danger" style="color: white" href="Aprende2.php?id=<?php echo $value['id']?>"><small> Aprender Videos</small></a>
        <a class="btn btn-danger" style="color: white" href="actividad.php?id=<?php echo $value['id']?>"><small> Realizar Prueba </small></a>
